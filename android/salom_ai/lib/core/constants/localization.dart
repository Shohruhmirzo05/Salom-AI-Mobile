...
final Map<String, Map<String, String>> _allTranslations = {
  "uz": {
    ...
    "payment": "To'lov",
    "paywall_subtitle": "Cheklovsiz suhbat, ovoz va eng aqlli modellar.",
    "paywall_footer": "Istalgan vaqt bekor qilinadi · Click",
    "payment_method_title": "To'lov turi",
    "payment_method_subtitle": "Click orqali. Birini tanlang.",
    "payment_one_time_title": "Bir martalik",
    "payment_one_time_short": "Click sahifasiga o'tasiz",
    "payment_auto_title": "Avtomatik yangilanish",
    "payment_auto_short": "Karta saqlanadi, har oy o'zi yangilanadi",
    "payment_security_note": "Xavfsiz to'lov · Click",
    "payment_link_error": "To'lov havolasini olib bo'lmadi.",
    // Card input
    "card_input_title": "Karta ma'lumotlari",
    "card_input_subtitle": "Xavfsiz to'lov Click tizimi orqali.",
    "card_number_label": "Karta raqami",
    "card_expiry_label": "Amal qilish muddati",
    "card_secure_private": "Maxfiy",
    "card_tokenize_error": "Kartani ulab bo'lmadi. Qayta urinib ko'ring.",
    // SMS verify
    "sms_verify_title": "SMS kodni kiriting",
    "sms_sent_to": "%@ raqamiga SMS kod yuborildi",
    "sms_sent_generic": "Kartangizga bog'langan raqamga SMS kod yuborildi",
    "sms_tip": "Click tomonidan yuborilgan kodni kiriting",
    "sms_verify_button": "Tasdiqlash",
    "sms_verify_error": "SMS kod xato yoki muddati o'tgan.",
  },
  "ru": {
    "settings": "Настройки",
    ...
    "continue": "Продолжить",
    "payment": "Оплата",
    "paywall_subtitle": "Безлимитный чат, голос и самые умные модели.",
    "paywall_footer": "Отмена в любое время · Click",
    "payment_method_title": "Способ оплаты",
    "payment_method_subtitle": "Через Click. Выберите вариант.",
    "payment_one_time_title": "Разовая оплата",
    "payment_one_time_short": "Перейдёте на страницу Click",
    "payment_auto_title": "Автопродление",
    "payment_auto_short": "Карта сохранится, продление каждый месяц",
    "payment_security_note": "Безопасная оплата · Click",
    "payment_link_error": "Не удалось получить ссылку на оплату.",
    // Card input
    "card_input_title": "Данные карты",
    "card_input_subtitle": "Безопасная оплата через систему Click.",
    "card_number_label": "Номер карты",
    "card_expiry_label": "Срок действия",
    "card_secure_private": "Конфиденциально",
    "card_tokenize_error": "Не удалось привязать карту. Попробуйте ещё раз.",
    // SMS verify
    "sms_verify_title": "Введите SMS-код",
    "sms_sent_to": "SMS-код отправлен на номер %@",
    "sms_sent_generic": "SMS-код отправлен на номер, привязанный к карте",
    "sms_tip": "Введите код, который прислал Click",
    "sms_verify_button": "Подтвердить",
    "sms_verify_error": "SMS-код неверный или истёк.",
  },
  "en": {
    "settings": "Settings",
    ...
    "continue": "Continue",
    "payment": "Payment",
    "paywall_subtitle": "Unlimited chat, voice and the smartest models.",
    "paywall_footer": "Cancel anytime · Click",
    "payment_method_title": "Payment method",
    "payment_method_subtitle": "Via Click. Pick one.",
    "payment_one_time_title": "One-time",
    "payment_one_time_short": "You'll go to the Click page",
    "payment_auto_title": "Auto-renew",
    "payment_auto_short": "Card saved, renews each month",
    "payment_security_note": "Secure payment · Click",
    "payment_link_error": "Could not get a payment link.",
    // Card input
    "card_input_title": "Card details",
    "card_input_subtitle": "Secure payment via the Click system.",
    "card_number_label": "Card number",
    "card_expiry_label": "Expiration date",
    "card_secure_private": "Private",
    "card_tokenize_error": "Could not link card. Try again.",
    // SMS verify
    "sms_verify_title": "Enter SMS code",
    "sms_sent_to": "SMS code sent to %@",
    "sms_sent_generic": "SMS code sent to the phone tied to the card",
    "sms_tip": "Enter the code Click sent you",
    "sms_verify_button": "Verify",
    "sms_verify_error": "SMS code is invalid or expired.",
  },
  "uz-Cyrl": {
    "settings": "Созламалар",
    ...
    "continue": "Давом этиш",
    "payment": "Тўлов",
    "paywall_subtitle": "Чексиз суҳбат, овоз ва энг ақлли моделлар.",
    "paywall_footer": "Истаган вақт бекор қилинади · Click",
    "payment_method_title": "Тўлов тури",
    "payment_method_subtitle": "Click орқали. Бирини танланг.",
    "payment_one_time_title": "Бир марталик",
    "payment_one_time_short": "Click саҳифасига ўтасиз",
    "payment_auto_title": "Автоматик янгиланиш",
    "payment_auto_short": "Карта сақланади, ҳар ой ўзи янгиланади",
    "payment_security_note": "Хавфсиз тўлов · Click",
    "payment_link_error": "Тўлов ҳаволасини олиб бўлмади.",
    // Card input
    "card_input_title": "Карта маълумотлари",
    "card_input_subtitle": "Хавфсиз тўлов Click тизими орқали.",
    "card_number_label": "Карта рақами",
    "card_expiry_label": "Амал қилиш муддати",
    "card_secure_private": "Махфий",
    "card_tokenize_error": "Картани улаб бўлмади. Қайта уриниб кўринг.",
    // SMS verify
    "sms_verify_title": "SMS кодни киритинг",
    "sms_sent_to": "%@ рақамига SMS код юборилди",
    "sms_sent_generic": "Картангизга боғланган рақамга SMS код юборилди",
    "sms_tip": "Click томонидан юборилган кодни киритинг",
    "sms_verify_button": "Тасдиқлаш",
    "sms_verify_error": "SMS код хато ёки муддати ўтган.",
  },
};
